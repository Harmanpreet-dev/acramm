...
export const metadata: Metadata = {
    ...
    description:
        "International Financial Reporting Standard (IFRS-9) requires provisioning to be carried out on the basis of Expected Credit Losses (ECL). A-Cra offers IFRS-9 Implementation support services to commercial banks and NBFIs in Myanmar.",
};
            ...
            <section className="relative overflow-hidden bg-brand-dark py-16 md:py-24" aria-labelledby="page-heading">
                ...
                <div className="section-container relative z-10">
                    ...
                    <p className="mt-4 max-w-2xl text-lg text-gray-300">
                        International Financial Reporting Standard (IFRS-9) requires provisioning to be carried out on the basis of &ldquo;Expected Credit Losses (ECL)&rdquo; as against &ldquo;Incurred Loss Approach&rdquo;. A-Cra offers IFRS-9 Implementation support services to commercial banks and NBFIs in Myanmar.
                    </p>
                </div>
            </section>
            ...
            <section className="section-padding bg-white" aria-labelledby="content-heading">
                <div className="section-container">
                    <div className="max-w-3xl space-y-6 text-brand-gray text-lg leading-relaxed">
                        ...
                        <p>
                            A-Cra collaborates closely with commercial banks and NBFIs by entering into formal Memorandum of Understanding (MOUs) for smooth implementation of IFRS-9.
                        </p>
                    </div>
                    ...
                    <div className="mt-12 flex justify-center overflow-hidden rounded-xl">
                        <Image
                            src={ifrs9Img}
                            alt="IFRS-9 Implementation Support Service"
