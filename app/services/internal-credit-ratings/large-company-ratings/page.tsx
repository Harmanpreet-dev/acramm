...
export const metadata: Metadata = {
    title: "Bank's (Internal) Large Company Credit Rating Models - ACraMM",
    description:
        "We are shortly coming up with Large Company Credit Rating Models for commercial banks for an effective credit risk assessment of their big corporate clients.",
};

export default function LargeCompanyRatingsPage() {
    return (
                ...
                <div className="section-container relative z-10">
                    <nav aria-label="Breadcrumb" className="mb-6">
                        <ol className="flex items-center gap-2 text-sm text-gray-400">
                            ...
                            <li aria-hidden="true">/</li>
                            <li className="text-brand-red">Large Company Ratings</li>
                        </ol>
                    </nav>
                    <h1 id="page-heading" className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
                        Bank&apos;s (Internal) Large Company Credit Rating Models
                    </h1>
                ...
                <div className="section-container">
                    <div className="rounded-xl bg-white p-8 text-center md:p-12">
                        <h3 className="mb-3 text-xl font-bold text-brand-dark">
                            Interested in Large Company Credit Rating Models?
                        </h3>
                        <p className="mb-6 text-brand-gray">
                            Get in touch with our team to learn how A-Cra&apos;s rating models can support your institution&apos;s large corporate credit assessments.
                        </p>
