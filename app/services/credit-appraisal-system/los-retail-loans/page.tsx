...
import losImg from "@/images/los.png";

export const metadata: Metadata = {
    title: "Loan Origination System (LOS) - Retail Loans - ACraMM",
    description:
        "A-Cra provides simple and user-friendly Score-Based Loan Origination Systems (LOS) for retail loans ensuring consistency, transparency, and quality credit decision-making.",
};
...
export default function LOSRetailLoansPage() {
    return (
                ...
                <div className="section-container relative z-10">
                    <nav aria-label="Breadcrumb" className="mb-6">
                        <ol className="flex items-center gap-2 text-sm text-gray-400">
                            ...
                            <li aria-hidden="true">/</li>
                            <li className="text-brand-red">LOS (Retail Loans)</li>
                        </ol>
                    </nav>
                    <h1 id="page-heading" className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
                        Loan Origination System (LOS)
                    </h1>
                    <p className="mt-2 text-xl text-brand-red font-semibold">Retail Loans</p>
                    <p className="mt-4 max-w-2xl text-lg text-gray-300">
                        A-Cra provides simple and user-friendly Score-Based Loan Origination Systems (LOS) for retail loans.
                    </p>
                </div>
            </section>
            ...
            <section className="section-padding bg-white" aria-labelledby="content-heading">
                <div className="section-container">
                    <div className="max-w-3xl space-y-6 text-brand-gray text-lg leading-relaxed">
                        <p>
                            This framework ensures consistency, transparency, and quality credit decision-making.
                        </p>
                    </div>
                ...
                <div className="section-container">
                    <div className="rounded-xl bg-brand-light p-8 text-center md:p-12">
                        <h3 className="mb-3 text-xl font-bold text-brand-dark">
                            Interested in LOS for Retail Loans?
                        </h3>
                        <p className="mb-6 text-brand-gray">
                            Get in touch with our team to learn how A-Cra&apos;s Loan Origination System can streamline your retail lending process.
                        </p>
